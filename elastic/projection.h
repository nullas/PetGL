...
public:
    ...
    Elastic::pOptimize parameter_;
    ofstream fout;
    bool check_derivative_, tangent_gradient_, initialized_, careful_;
    ...
    Vec3d ComputeGradientBending(const Vec3d &e, const Vec3d f, int i);
