...
ProjectionThreading::ProjectionThreading(Elastic *p, QString _fin) :
...
void ProjectionThreading::run()
{
    ...
    for (i = 0; i < iteration; ++i)
    {
        ...
        TangentProjection hp(curve_, constraints_, p_->pO);
        hp.check_derivative(true);
...
void ProjectionThreading::ClearAllConstraints()
{
